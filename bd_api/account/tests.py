...
@pytest.mark.django_db
@patch("bd_api.account.signals.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("bd_api.account.signals.render_to_string")
...
@pytest.mark.django_db
@patch("bd_api.account.views.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("bd_api.account.views.render_to_string")
@patch("bd_api.account.signals.render_to_string")
