...
import bd_api.account.models
import bd_api.account.storage
import bd_api.api.v1.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        storage=bd_api.account.storage.OverwriteStorage(),
                        upload_to=bd_api.account.models.image_path_and_rename,
                        validators=[bd_api.api.v1.validators.validate_is_valid_image_format],
                        verbose_name="Imagem",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", bd_api.account.models.BDGroupManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", bd_api.account.models.BDRoleManager()),
            ],
        ),
        migrations.CreateModel(
            name="BDGroupRole",
