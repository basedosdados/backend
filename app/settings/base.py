...
GRAPHENE = {
    "SCHEMA": "app.api.v1.schema.schema",
    "MIDDLEWARE": [
...
HAYSTACK_CONNECTIONS = {
    "default": {
        "ENGINE": "app.api.v1.haystack_engines.AsciifoldingElasticSearchEngine",
...
HAYSTACK_SIGNAL_PROCESSOR = "app.api.v1.signals.BDSignalProcessor"
