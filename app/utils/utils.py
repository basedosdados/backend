...
def zip_and_save_bq_table(
    dataset: str, table: str, limit: Optional[int] = 20000
) -> str:
    """
    Compress a table from BigQuery Dataset to zip file, and upload
    it to the bucket. The file will be uploaded to the
    <BUCKET_NAME>/datasets/<dataset>/<table>.csv.zip
    ...
    Args:
        ...
        limit (int, optional): rows limit for the pandas_gbq. Default to 20000
