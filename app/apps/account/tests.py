...
@pytest.mark.django_db
@patch("app.apps.account.signals.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("app.apps.account.signals.render_to_string")
...
@pytest.mark.django_db
@patch("app.apps.account.views.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("app.apps.account.views.render_to_string")
@patch("app.apps.account.signals.render_to_string")
