...
import app.account.storage
import app.api.v1.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        storage=app.account.storage.OverwriteStorage(),
                        upload_to=app.account.models.image_path_and_rename,
                        validators=[app.api.v1.validators.validate_is_valid_image_format],
                        verbose_name="Imagem",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", app.account.models.BDGroupManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", app.account.models.BDRoleManager()),
            ],
        ),
        migrations.CreateModel(
            name="BDGroupRole",
