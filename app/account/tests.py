...
@pytest.mark.django_db
@patch("app.account.signals.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("app.account.signals.render_to_string")
...
@pytest.mark.django_db
@patch("app.account.views.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("app.account.views.render_to_string")
@patch("app.account.signals.render_to_string")
