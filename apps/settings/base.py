...
from apps.logger import InterceptHandler
...
INSTALLED_APPS = [
    ...
    "apps.apps.api.v1",
    "apps.apps.schemas",
    "apps.apps.payments.apps.PaymentsConfig",
]
...
GRAPHENE = {
    "SCHEMA": "apps.apps.api.v1.schema.schema",
    "MIDDLEWARE": [
...
GRAPHQL_JWT = {
    ...
    "JWT_ALLOW_ANY_HANDLER": "app.custom.allow_any.allow_any",
}
...
HAYSTACK_CONNECTIONS = {
    "default": {
        "ENGINE": "apps.apps.api.v1.haystack_engines.AsciifoldingElasticSearchEngine",
...
HAYSTACK_SIGNAL_PROCESSOR = "apps.apps.api.v1.signals.BDSignalProcessor"
