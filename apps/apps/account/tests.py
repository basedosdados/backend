...
@pytest.mark.django_db
@patch("apps.apps.account.signals.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("apps.apps.account.signals.render_to_string")
...
@pytest.mark.django_db
@patch("apps.apps.account.views.EmailMultiAlternatives")
...
@pytest.mark.django_db
@patch("apps.apps.account.views.render_to_string")
@patch("apps.apps.account.signals.render_to_string")
