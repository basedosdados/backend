...
import apps.apps.account.models
import apps.apps.account.storage
import apps.apps.api.v1.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        storage=apps.apps.account.storage.OverwriteStorage(),
                        upload_to=apps.apps.account.models.image_path_and_rename,
                        validators=[apps.apps.api.v1.validators.validate_is_valid_image_format],
                        verbose_name="Imagem",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", apps.apps.account.models.BDGroupManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            managers=[
                ("objects", apps.apps.account.models.BDRoleManager()),
            ],
        ),
        migrations.CreateModel(
            name="BDGroupRole",
